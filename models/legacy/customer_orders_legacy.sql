WITH paid_orders as (select Orders.ID as order_id,
    ...
    FROM test.dbt_raj_test.orders as Orders
...
left join test.dbt_raj_test.customers C on orders.USER_ID = C.ID ),
...
customer_orders 
    ...
    from test.dbt_raj_test.customers C 
    left join test.dbt_raj_test.orders as Orders
